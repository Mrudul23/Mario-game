...
function setup() {
    canvas = createCanvas(windowWidth - 35, windowHeight-20);
    ...
    startButton=createSprite(0,780);
...
function draw() {
    ...
    image(inst,-300,windowHeight/2,600,400)
  ...
  if (gameState==="PLAY") {
    ...
    if(gameState === "PLAY"){
        ...
        textSize(40)
        text("Lives: "+lives +" |",mario.x-350,300);
        text(" Coins collected: "+score/10,mario.x-150,300);
        if (mario.x>=5160) {
        swal({
